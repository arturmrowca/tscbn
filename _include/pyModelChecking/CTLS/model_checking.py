...
from _include.pyModelChecking.kripke import Kripke

import sys

if '_include.pyModelChecking.CTL' not in sys.modules:
    import _include.pyModelChecking.CTL

CTL=sys.modules['_include.pyModelChecking.CTL']

if '_include.pyModelChecking.LTL' not in sys.modules:
    import _include.pyModelChecking.LTL

LTL=sys.modules['_include.pyModelChecking.LTL']
