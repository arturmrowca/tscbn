...
from _include.pyModelChecking.CTLS import LNot as LNot
...
class A(StateFormula,CTLS.A):
    ...
    def get_equivalent_restricted_formula(self):
        ...
        if (isinstance(p_formula,CTLS.W)):
            return Not(EU(neg_sf1,Not(Or(sf0,sf1))))
...
def AW(subformula0,subformula1):
    return A(W(subformula0,subformula1))
	
def EW(subformula0,subformula1):
    return E(W(subformula0,subformula1))
