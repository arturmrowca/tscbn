...
class VariationalInferenceParameterEstimator(ParameterEstimator):
    '''
    Variational Inference Algorithm
    '''

    def __init__(self):
        super(VariationalInferenceParameterEstimator, self).__init__()
    ...
    def _update_latent_time(self, node, seq_id, observation):
        ...
        for outcome in self._relevant_outcome_combos[seq_id]:
            ...
            # 6. Compute q_all = q1(this_outcome) q2(this_outcome)
        ...
        if mu_denominator == 0:
            mu_denominator = 0.01
        self._q_latent_t[seq_id][node]["mean_base"] = mu_numerator / mu_denominator
