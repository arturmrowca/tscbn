...
from _include.m_utils import prefix_tree
...
class PrefixStructureDiscoverer(Base):
    '''
    Prefix Tree Structure Discovery
    '''
    ...
    def discover_structure(self, sequences, states_dict):
        '''
        ...
        #L().log.info('---------------------------------------------------------------')
        return pgm_structure.nodes, [list(edge) for edge in pgm_structure.edges], states_dict, []
    ...
    def create_dawg(self, sequences):
        ...
        trie, root = prefix_tree(sequences)  # create prefix tree, also called trie
