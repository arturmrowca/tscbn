...
class TSCBNStructureModel(BaseStructureModel):
                    ...
                    for app_time in last:
                        ...
                        if not self._diabled_previous_inter_edge:
                            ...
                            if nex != -1:
                                ...
                                if not new_e2 in e and "_".join(new_e2[0].split("_")[:-1]) != "_".join(new_e2[1].split("_")[:-1]):
                                    e += [new_e2]
                                    t = None
                        ...
                        # Add if not existing
                        if not new_e in e and "_".join(new_e[0].split("_")[:-1]) != "_".join(new_e[1].split("_")[:-1]):
                            e += [new_e]
                            # store temporal gap to this object
    ...
    def _random_pick_uniform(self, elements, nr_elements):
        ...
        assert len(l) > 0, "_random_pick_uniform received empty list"
